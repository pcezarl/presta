...
$tipo="<b><span style='font-size:10pt'>{$dados->ed_nome} - {$dados->ap_num}</span></br> <br/><span style='font-size:7pt;font-family:verdana'>{$dados->pr_num}/$max_presta</span> $mini_tipo";
