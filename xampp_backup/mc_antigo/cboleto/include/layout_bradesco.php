...
<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
  <tr>
    <td width=41><img src="imagens/logo_aires.png" class="logo_empresa"></td>
    <td class=ti width=455>{{identificacao}} - {{cpf_cnpj}} <br>
	{{endereco}}<br>
	{{cidade_uf}}<br>
    </td>
...
n&uacute;mero</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top  width=113 height=12><div align=left> 
  <span class="campo">
  {{data_documento}} </span></div></td><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=153 height=12> 
    <span class="campo">
    {{numero_documento}}   </span></td>
 ...
 {{aceite}}</span> 
   ...
   <span class="campo">
   {{data_processamento}}  </span></div></td><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top align=right width=180 height=12> 
     <span class="campo">
     {{nosso_numero}}    </span></td>
...
<div align=left> <span class="campo">
  {{carteira}}</span></div></td><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top  width=53><div align=left><span class="campo">
{{especie}}</span> 
...
<td valign=top width=7 height=1><img height=1 src=imagens/2.png width=1 border=0></td></tr></tbody></table></td><td valign=top width=468 rowspan=5><font class=ct>Informa&ccedil;&otilde;es de responsabilidade do benefici&aacute;rio 
</font><br><br><span class=cp> <FONT class=campo>
{{instrucoes1}}<br>
{{instrucoes2}}<br>
{{instrucoes3}}<br>
