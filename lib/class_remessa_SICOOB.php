<?php
        ...
        class remessa_SICOOB {
            ...
            public function header($data) {
                ...
                $this->codigo_lote_servico  = minimo('0001', 4, 1); #A cada novo lote, pegar esse numero + 1   
                ...
                $this->codigo_cooperativa   = minimo($data['agencia'], 5, 1).modulo_11($data['agencia']); #Codigo Cooperativa (5) + dv (1)
                ...
                $header_arquivo = 
                    ...
                    .$tipo_pessoa.minimo(unmask($documento),14, 1).vazios(20)
                    .$this->codigo_cooperativa.$this->codigo_beneficiario.'0'.$nome_empresa.$nome_banco.vazios(10)                
                    .'1'.$data_arquivo.$hora_arquivo.$numero_sequencia_arquivo.$versao_layout.$densidade.vazios(69);
                
                $header_lote =
                    $this->codigo_banco.$this->codigo_lote_servico.'1'.'R'.'01'.vazios(2).'040'.' '
                    .'2'.minimo($numero_inscricao, 15, true).vazios(20).$this->codigo_cooperativa.$this->codigo_beneficiario.' '
            ...
            public function registro($data) {
                ...
                $tipo_documento_pagador     = strlen(unmask($data['documento_pagador'])) > 13 ? '2': '1'; #1: CPF - 2: CNPJ
            ...
            public function trailer($data) {
                ...
                $file = new file();
                $file->save(ltrim($txt), $path.$filename);
