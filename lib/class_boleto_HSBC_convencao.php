...
private $identificacao_empresa="Aires Desenvolvimento Imobiliário Ltda"; // nome da empresa
...
public parcela 01/02 Convençao Condominial: $taxa_boleto=205.00; // taxa do boleto
