  ...
  <BODY text=#000000 bgColor=#ffffff topMargin=0 rightMargin=0>
    ...
    <table cellspacing=0 cellpadding=0 width=666 border=0>
      <tr>
        <td class=cp width=150>
          <span class="campo"><span style="font-family:Arial,Helvetica,sans-serif;font-size:26pt;font-weight:bold;letter-spacing:1px">ASA</span></span></td>
    ...
    <table cellspacing=0 cellpadding=0 border=0>
      <tbody>
        ...
        <tr>
          <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td>
          <td class=cp valign=top width=472 height=12 class="bold">PAGAVEL EM QUALQUER BANCO ATE O VENCIMENTO</td>
